...
<html lang="en" >
    ...
    <body  class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
                        ...
                        <div class="m-login__signin">
                            ...
                            @csrf
                                <div class="form-group m-form__group">
                                   <input id="username" type="text" class=" m-input form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus>
                                ...
                                <div class="form-group m-form__group">
                                     ...
                                     <input id="password" type="password" class="form-control m-input m-login__form-input--last {{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
        ...
        <!--end::Base Scripts -->   
        <!--begin::Page Snippets -->
         <script src="{{ asset('admin/assets/snippets/custom/pages/user/login.js') }}"></script>
        <!--end::Page Snippets -->
    </body>
    <!-- end::Body -->
</html>
